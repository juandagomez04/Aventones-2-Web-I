...
<head>
  ...
  <title>Registro de Conductores - Aventones</title>

  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  <!-- Mismo CSS, pero con base_url para CI4 -->
...
<body class="auth">
  <div class="container">
    ...
    <!-- Registration Form -->
    <form class="form" action="<?= site_url('register/driver') ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="links">
        ...
        <p class="register-driver-link">
          ...
          <a href="<?= site_url('register/passenger') ?>">Click here</a>
        </p>
      </div>
