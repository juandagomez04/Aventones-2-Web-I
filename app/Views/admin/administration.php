...
<body>
    ...
    <main class="admin-wrap">
        ...
        <div class="admin-actions">
            ...
            <a href="<?= site_url('admin/reports/searches') ?>" class="btn primary">
                Search Reports
            </a>
        </div>
                            ...
                            <td>
                                <div class="actions">
                                    <?php if ($user['status'] === 'active'): ?>
                                        <form method="post" action="<?= site_url('admin/users/action') ?>"
                                            style="display:inline;" onsubmit="return confirm('Desactivate this user?')">
                                    ...
                                    <?php if ($user['role'] === 'admin'): ?>
                                        <form method="post" action="<?= site_url('admin/users/action') ?>"
                                            style="display:inline;" onsubmit="return confirm('Delete this admin?')">
                                            <input type="hidden" name="action" value="delete">
                                            <input type="hidden" name="id" value="<?= $user['id'] ?>">
                                            <button type="submit" class="link warn">Delete</button>
                                        </form>
        ...
        <section id="create-admin" class="panel">
            <h3>Create Admin</h3>
            <form method="post" action="<?= site_url('admin/users/action') ?>" enctype="multipart/form-data">
    ...
    <script>
        function updateFilters() {
            ...
            window.location.href = `<?= site_url('admin') ?>?role=${role}&status=${status}`;
        }
    </script>
